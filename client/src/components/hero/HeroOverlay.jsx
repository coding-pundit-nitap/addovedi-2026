                    ...
                    {isSidebarOpen && (
                        <>
                            ...
                            >
                                ...
                                {/* Bottom segment of sidebar: status + register */}
                                <div className="mt-auto border-t border-[#00f0ff]/15 pt-6 flex flex-col gap-5 relative z-10">
                                    ...
                                    {/* Mobile register button inside sidebar */}
                                    <div className="reg-btn-wrap w-full">
                                        <button
                                            ...
                                            className="reg-btn group w-full text-center flex justify-center items-center py-3.5"
                                        >
                                            {/* Border: animated cyan gradient */}
                                            <div
                                                className="absolute inset-0"
